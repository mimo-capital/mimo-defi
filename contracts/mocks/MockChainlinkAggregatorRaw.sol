...
contract MockChainlinkAggregatorRaw is AggregatorV3Interface {
  ...
  constructor(uint8 _decimals, uint256 _latestPrice, string memory _description) public {
    decimals = _decimals;
